...
Adjoindre le WER (via github?), voire le score ROUGE. A moyen terme, permettre d'avoir la main pour lancer les expés.
Par exemple en utilisant [un outil trouvé sur GitHub ?](https://github.com/jitsi/asr-wer/blob/master/jiwer/wer.py)


## 2. Implémenter les solutions de visualisation développée dans les travaux de Montavon
...
## Tâches et données typiques des conférences du domaine
